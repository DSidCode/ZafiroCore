...
- **Estado:** Pendiente
- **Descripción:** Refactorizar la gestión de tareas para que cada proyecto sea una "tarjeta" individual con sus propias metas, propósitos y tareas, ofreciendo una visión global y conceptual de cada iniciativa.
...
## 💻 SOPORTE TÉCNICO / IT PERSONAL
*Tareas relacionadas con el mantenimiento y configuración de tus sistemas operativos y hardware.*

### 🖥️ Configuración HDMI en Nobara Linux
- **Estado:** Finalizado
- **Descripción:** Resuelto el problema de congelamiento del sistema operativo al conectar un monitor HDMI.
- **Subtareas:**
  - [x] Investigar drivers de la tarjeta gráfica (NVIDIA/AMD).
  - [x] Buscar soluciones específicas para Nobara Linux y HDMI.
  - [x] Probar diferentes configuraciones de pantalla.